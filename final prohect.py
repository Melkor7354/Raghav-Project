...
def player_transfer():
    transfers = random.sample(player_base, 2)
    ret = []
...
bg3 = pygame.image.load(
    "pngtree-background-with-a-football-or-soccer-ball-on-grass-with-spotlight-picture-image_2032894.jpg")
...
#
    ...
    if i == 2 and r == 1:
        ...
        if a2 == 1:
            ...
            if rand_int < rand2:
                display_text(font_x, "you lose", 600, 455, 100, 100, 100)
